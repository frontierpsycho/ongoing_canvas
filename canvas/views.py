...
class PlaygroundView(CanvasView):
	...
	def get_queryset(self):
		...
		form_generator = FormGenerator("canvas/form_data/colors.json", "canvas/form_data/shapes.json", GridPlacementStrategy(settings.CANVAS_HEIGHT, settings.CANVAS_WIDTH, 50, 50, depth=1))
